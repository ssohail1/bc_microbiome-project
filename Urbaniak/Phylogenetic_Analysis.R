...
map <- import_qiime_sample_data("/media/mbb/Sidras_Projects/Urbaniak_paper/fastqfiles/UrbaniakMetadata.txt")
##Assigning species
taxa.plus <- addSpecies(taxa, "/media/mbb/Sidras_Projects/Urbaniak_paper/fastqfiles/silva.nr_v138.align", verbose=TRUE)
colnames(taxa.plus) <- c("Kingdom", "Phylum", "Class", "Order", "Family", "Genus","Species")
unname(taxa.plus)
###0 out of 6943 were assigned to the species level.
